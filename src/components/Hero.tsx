      ...
      <div className="bg-white relative pt-40 pb-20 lg:pt-44 ">
        <div className="relative xl:container m-auto px-6 md:px-12 lg:px-6">
          <h1 className="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-4xl text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-7xl ">
            Run successful Business with <br className="lg:block hidden" />{" "}
          ...
          <div className="lg:flex">
            <div className="relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
              <p className="sm:text-lg text-gray-700 dark:text-gray-300 lg:w-11/12">
                ...
                Eligendi perspiciatis harum totam praesentium qui libero porro.
                Cum voluptatem quos soluta corporis aut expedita.
              </p>
              <span className="block font-semibold text-gray-500 dark:text-gray-400">
                The best Agency for your business needs
              </span>
              <div className="grid grid-cols-3 space-x-4 md:space-x-6 md:flex md:justify-center lg:justify-start">
                ...
                >
                  <div className="flex justify-center space-x-4">
                    <img
                      className="w-6 h-6"
                      src="https://image.cnbcfm.com/api/v1/image/105684220-1547727181154mb_slack_01.jpg?v=1547727329&w=1600&h=900"
                      alt="slack logo"
                      loading="lazy"
                      width="128"
                      height="128"
              ...
              <div className="pt-12 flex gap-4 lg:gap-12 justify-between grayscale lg:w-2/3">
